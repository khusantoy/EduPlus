...
@section('content')
    <h1 class="h3 mb-3"><strong>Users</strong> Archive</h1>
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <table class="table table-bordered table-hover">
                        ...
                        @foreach($users as $user)
                            <tr>
                                ...
                                <td>
                                    <a href="{{route('users.restore',$user->id)}}" class="btn btn-warning">
                                    ...
                                    <form class="d-inline" action="{{route('users.remove',$user->id)}}">
