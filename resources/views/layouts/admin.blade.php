...
<head>
    ...
    <meta name="description" content="EduPlus-Learning Management System">
    <meta name="author" content="KhusanboyTursunov">
    ...
    <nav id="sidebar" class="sidebar js-sidebar" >
        <div class="sidebar-content js-simplebar">
            <a class="sidebar-brand" href="index.html">
                <span class="align-middle">EduPlus</span>
            </a>
                ...
                <ul class="navbar-nav navbar-align">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <a class="nav-link dropdown-toggle d-none d-sm-inline-block" href="#" data-bs-toggle="dropdown">
                            <img src="{{asset('eduplus/img/avatars/avatar.jpg')}}" class="avatar img-fluid rounded me-1" alt="Charles Hall" /> <span class="text-dark">Charles Hall</span>
                        </a>
